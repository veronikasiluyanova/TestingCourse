...
namespace AircompanyTests.Tests
{
    ...
    {       
        ...
        [Test]
        public void HasMilitaryTransportPlaneUnitTest()
        {           
            Assert.IsTrue(HasMilitaryTransportPlane());
        }

        [Test]
        public void MaxPassengerCapacityUnitTest()
        {
            Assert.AreEqual(airport.GetPassengerPlaneWithMaxPassengersCapacity(), planeWithMaxPassengerCapacity);
        }

        [Test]
        public void SortByMaxLoadCapacityUnitTest()
        {            
            Assert.IsTrue(IsSortMaxLoadCapacityPlaneCorrect());
        }
    }
}
